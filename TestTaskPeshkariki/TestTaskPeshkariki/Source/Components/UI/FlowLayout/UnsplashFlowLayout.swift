...
final class UnsplashFlowLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        guard let collectionView = collectionView, collectionView.numberOfSections == 1 else {
            return assert(false, "Unsplash view layout needs one section in collection view")
        }
...
private extension UnsplashFlowLayout {
    struct Static {
